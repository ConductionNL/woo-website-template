...
## Backend
Voor de backend zijn twee opties beschickbaar, in bijde gevallen moet de resulterende url worden opgenomden onder `API_BASE_URL` in de frontend configuratie.
